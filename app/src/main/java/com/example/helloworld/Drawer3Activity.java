...
public class Drawer3Activity extends AppCompatActivity {
    Toolbar toolbar;
    TabLayout tabLayout;
    ViewPager viewPager;
...
//mDrawerLayout=(DrawerLayout)findViewById(R.id.nav_view);
      ...
      navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
          ...
          public boolean onNavigationItemSelected(@NonNull @NotNull MenuItem item) {
              switch (item.getItemId()){
                  ...
                  case R.id.nav_1:Intent intent1=new Intent(Drawer3Activity.this,DrawerActivity_test1.class);
                      startActivity(intent1);
                      break;

                  case R.id.nav_2:Intent intent2=new Intent(Drawer3Activity.this,Drawer2Activity.class);
    ...
    private class MainAdapter extends FragmentPagerAdapter {
        ArrayList<String> arrayList=new ArrayList<String>();//新建arraylist
